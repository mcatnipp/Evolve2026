# Evolve Website Copy — Markets, Company and Conversion

**Content package:** COPY-001C v1.0  
**Status:** Mixed—approved-scope pages are production-ready; legal, recruiting and specialized-market pages remain gated  
**Upstream:** GOV-001 v1.0 · MKT-001 v1.1 · ARCH-001 v1.0 · DS-001 v1.0  
**Prepared:** September 7, 2026  

---

# PAGE-500 — Data Center Markets

**URL:** `/data-center-markets/`  
**Page brief:** INTENT-500  
**Audience:** Owners, developers and operators comparing requirements by facility and operating environment  
...
- `CollectionPage`, `WebPage` and `BreadcrumbList`.
- Do not use sector credentials, certifications or customer examples.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Markets/lifecycle framing | CLM-001–005 | Pass |
| Aggregate proof | CLM-002, 006, 007 | Pass |
| Specialized-sector claims | CLM-036 and AD-005 | Pass—excluded |

**Content approval status:** Ready for stakeholder review; factual claims ledger pass complete.

---

# PAGE-510 — Colocation Data Centers

**URL:** `/data-center-markets/colocation/`  
**Page brief:** INTENT-510  
**Audience:** Colocation owners, developers, program teams and operators  
**Primary action:** Discuss a Colocation Project  
...
Carry turnover knowledge into monitoring, maintenance and long-term support.
...
- eLERT should be added here only after its public product definition and page are approved.
...
- Do not add customer, location, compliance or certification claims.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Lifecycle and facility-change scope | CLM-003, 004, 013, 014 | Pass |
| Aggregate proof | CLM-006, 007 | Pass |
| Customer/project proof | CLM-025, 026 | Pass—excluded |

**Content approval status:** Ready for stakeholder review; factual claims ledger pass complete.

---

# PAGE-520 — Enterprise Data Centers

**URL:** `/data-center-markets/enterprise/`  
**Page brief:** INTENT-520  
**Audience:** Enterprise infrastructure executives, IT leaders, facility leaders and risk teams  
**Primary action:** Discuss an Enterprise Facility  
...
[Power Generation](/power-generation/)  
[Service & Maintenance](/maintenance/)  
The eLERT path should be added here only after its public product definition and page are approved.
...
- `Service`, `WebPage` and `BreadcrumbList`.
- Do not imply named enterprise experience, compliance credentials or product limits.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| New/existing facility capability | CLM-013, 014 | Pass |
| Lifecycle | CLM-003, 004 | Pass |
| eLERT/facility assessment specifics | AD-003/AD-006 | Pass—identified as gated |
...
**URL:** `/insights/`  
**Page brief:** INTENT-600  
**Audience:** Owners, developers, engineers, power teams, construction teams and operators researching decisions  
**Primary action:** Explore Insights  
...
- [Data Center Site Selection & Power Planning](/insights/data-center-site-selection-power-planning/)
- [Responsible Data Center Development](/insights/responsible-data-center-development/)

#### Delivery Approaches

- [Modular vs. Traditional Data Center Delivery](/insights/modular-vs-traditional-data-center-delivery/)
- [Hyperscale Campus Phasing](/insights/hyperscale-campus-phasing/)

#### AI Infrastructure

- [AI Data Center Infrastructure Planning](/insights/ai-data-center-infrastructure-planning/)
...
- `CollectionPage`, `WebPage` and `BreadcrumbList`.
- Each article uses `Article` with visible author/reviewer, publish/update dates and cited sources.

## Claim review

| Module | Claim IDs / sources | Review |
|---|---|---|
| Lifecycle topics | CLM-003, 004 | Pass |
| Editorial/source standard | MKT-001 v1.1 | Pass |

**Content approval status:** Ready for stakeholder review; factual claims ledger pass complete.

---

# PAGE-700 — About Evolve

**URL:** `/about/`  
**Page brief:** INTENT-700  
**Audience:** Executives, procurement teams, partners and prospective employees  
...
Add the Careers link after the current recruiting destination and application process are approved.
...
- `AboutPage`, `Organization` and `BreadcrumbList`.
- Approved fields only: name, controlled logo, founding year, address, phone and governed description.
- Do not add clients, awards, ratings, employee count or international service claims.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Specialization/nationwide | CLM-001, 002 | Pass |
| Lifecycle and capability | CLM-003, 004, 011, 013, 014 | Pass |
| Company identity | CLM-008, 009, 039 | Pass |
| Aggregate proof and safety | CLM-006, 007, 010 | Pass |
| Confidential items | CLM-024–026, 033 | Pass—excluded |

**Content approval status:** Ready for stakeholder review; reconfirm CLM-039 before launch.
...
**URL:** `/contact/`  
**Page brief:** INTENT-720  
**Audience:** All inquiry types  
**Primary action:** Route My Inquiry  
...
Use the approved recruiting destination when current opportunities and application instructions are confirmed.
...
- Phone — optional.
- Message — required.
- Consent/privacy acknowledgment — required where applicable.

**Submit label:** Route My Inquiry

**Success message:** Thank you. Your inquiry has been received and routed using the information you provided. If your request concerns an immediate life-safety emergency, use the appropriate emergency authority rather than this form.

No response time is promised on the public page.
...
- `ContactPage`, `Organization` reference and `BreadcrumbList`.
- Use only CLM-039 for visible and structured contact details.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Address and phone | CLM-039 | Pass—reconfirm at launch |
| Response expectation | CLM-031 | Pass—no promise |
...
**URL:** `/support/`  
**Audience:** Existing customers and authorized contacts  
**Primary action:** Request Support  
...
- Company — required.
- Work email — required.
- Phone — required when phone contact is requested.
- Existing Evolve reference — optional unless required by the support process.
- Facility identifier — use the approved internal identifier; do not expose sensitive location details unnecessarily.
- Affected service/system — required select after support taxonomy is approved.
- Description — required.
- Attachment — only if secure handling and retention rules are approved.
...
- `WebPage` and `BreadcrumbList`; no public service-level or availability properties.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Existing support route | CLM-013 | Pass |
| Response/availability | CLM-031 | Pass—no promise |

**Content approval status:** Ready for stakeholder review; secure form behavior requires implementation approval.

---

# PAGE-800 — Start a Project

**URL:** `/start-a-project/`  
**Indexing:** `noindex, follow`  
**Primary action:** Submit Project Brief  
...
- Primary interest — required: Design & Build, Modular Data Centers, Hyperscale Data Centers, AI Data Centers, Power Generation, Service & Maintenance, Other.
- Project stage — required.
- State/region — required; do not imply existing Evolve work in that location.
- Facility type — required.
- Project summary — required.
- Immediate constraint or decision — required.
- Target timing — optional and treated as an owner input, not an Evolve commitment.
- File upload — enable only after security and retention approval.
- Consent/privacy acknowledgment — required where applicable.

**Submit label:** Submit Project Brief

**Microcopy:** Submission begins a qualification discussion. It does not create a contract, schedule commitment, response guarantee or confidentiality agreement.

### Success message

## Your project brief has been received.

Evolve will route the information based on the project type and need you selected. Keep the confirmation reference for follow-up.

For an existing-customer issue, use [Support](/support/). For a maintenance request, use [Request Service](/request-service/).
...
- `WebPage`; `noindex, follow`.
- Do not use `Service` or `Offer` fields on the form page.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Lifecycle/service routing | CLM-003–005, 013, 014 | Pass |
| Commitments and confidentiality | Governance controls | Pass—disclaimer included |

**Content approval status:** Ready for stakeholder review; form security, routing and privacy implementation require approval.

---

# PAGE-810 — Request Service

**URL:** `/request-service/`  
**Indexing:** `noindex, follow`  
**Primary action:** Submit Service Request  
...
- Service interest — Preventive Maintenance, Power Generation Maintenance, Critical Infrastructure Maintenance, Existing-Customer Support, Other.
- Facility status — operating, commissioning, construction, planned.
- Request summary — required.
- Operating constraint or known issue — required.
- Preferred contact method — required.
- Attachment — only after secure handling approval.
- Consent/privacy acknowledgment — required where applicable.
...
| Module | Claim IDs | Review |
|---|---|---|
| Service routing | CLM-013, 014 | Pass |
| Response/availability | CLM-031 | Pass—no promise |

**Content approval status:** Ready for stakeholder review; form routing and privacy implementation require approval.

---

# PAGE-830 — Form Confirmation
...
**Title:** Submission Received | Evolve  
**Meta description:** Confirmation that Evolve has received the submitted inquiry.  

## Schema recommendation

- Basic `WebPage`; `noindex, nofollow`.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Submission and next-step language | No Evolve factual claim required | Pass |
| Contract/schedule/response statement | Governance controls | Pass—no commitment created |

**Content approval status:** Ready for implementation.

---

# PAGE-770 — HTML Sitemap
...
- Add approved maintenance children only when their holds are resolved.
...
- [Start a Project](/start-a-project/)
- [Request Service](/request-service/)
- Add Privacy Policy, Accessibility and Terms of Use links only after those pages are approved and published.
...
- `CollectionPage` and `BreadcrumbList`.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Published page inventory | ARCH-001 publication status | Pass—dynamic generation required |
| Gated destinations | AD-002–006 | Pass—excluded until approved |

**Content approval status:** Ready, but generate links dynamically from published/indexable page status.

---

# Gated pages — no production approval

| Page ID | Page | URL | Required input before copy approval |
|---|---|---|---|
| PAGE-530 | Edge & Distributed Data Centers | `/data-center-markets/edge-distributed/` | Approve Evolve-specific edge capability and public modular/product language |
| PAGE-540 | Healthcare Data Centers | `/data-center-markets/healthcare/` | Confirm commercial priority and approved sector capability; do not claim HIPAA certification |
| PAGE-550 | Financial Services Data Centers | `/data-center-markets/financial-services/` | Confirm commercial priority and approved sector capability; do not claim PCI credentials |
| PAGE-560 | Telecommunications Data Centers | `/data-center-markets/telecommunications/` | Confirm commercial priority and approved sector capability |
| PAGE-570 | Government & Education Data Centers | `/data-center-markets/government-education/` | Confirm commercial priority and approved sector capability; do not claim FedRAMP/FISMA credentials |
| PAGE-580 | Energy & Industrial Data Centers | `/data-center-markets/energy-industrial/` | Confirm commercial priority and approved sector capability |
| PAGE-710 | Careers | `/careers/` | Current recruiting destination, equal-opportunity language and application process |
| PAGE-740 | Privacy Policy | `/privacy-policy/` | Actual form, analytics, CRM, cookie, retention, transfer and privacy practices; legal review |
| PAGE-750 | Accessibility | `/accessibility/` | Approved accessibility commitment, contact route and conformance review process |
| PAGE-760 | Terms of Use | `/terms/` | Legal entity, governing terms, acceptable use and counsel approval |

Do not publish generic legal templates or market-sector claims as substitutes for approved facts.
...
**Evolve Data Center Solutions**  
Data-center planning, design, construction, power, monitoring and maintenance.  
10555 Cossey Road, Houston, Texas 77070  
832-375-0099
...
- File size: “This file exceeds the approved upload limit.”
- Server error: “The form could not be submitted. Your entries remain on this page. Try again or call 832-375-0099.”

## Search empty state

**No matching pages found.**  
Try a service, market or lifecycle term, or [contact Evolve](/contact/).

## 404 page

# This page is not available.

The address may have changed or the page may have been removed. Use the paths below to continue.
...
| Review ID | Pages | Claim check | Intent coverage | Confidentiality | Decision |
|---|---|---|---|---|---|
| REV-COPY-001C-1 | PAGE-500, 510, 520, 600, 700, 720, 730, 770, 800, 810, 830 | Pass against GOV-001 v1.0 | Pass | Pass | Ready for Evolve stakeholder review |
| REV-COPY-001C-2 | PAGE-530–580, 710, 740–760 | Claims/process inputs unresolved | N/A | Pass | **DO NOT PUBLISH** |

## Change-log entry

| Change ID | Timestamp | Artifact/version | Old state | New state | Reason | Upstream IDs | Affected pages |
|---|---|---|---|---|---|---|---|
| COPY-CHG-001C | 2026-09-07 | COPY-001C v1.0 | Templated Markets/Solutions/Industries and mixed inquiry paths | Buyer-specific market copy and segmented conversion content | Clarify audiences, preserve confidentiality and route commercial inquiries accurately | GOV-001, MKT-001, ARCH-001, DS-001 | PAGE-500–830 as listed |
