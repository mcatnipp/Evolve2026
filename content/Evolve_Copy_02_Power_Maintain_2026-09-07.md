# Evolve Website Copy — Power and Maintain

**Content package:** COPY-001B v1.0  
**Status:** Mixed—approved-scope pages are production-ready; gated pages remain DO NOT PUBLISH  
**Upstream:** GOV-001 v1.0 · MKT-001 v1.1 · ARCH-001 v1.0 · DS-001 v1.0  
**Prepared:** September 7, 2026  

## Publishing controls

- Publishable pages in this file: PAGE-200 Power Generation, PAGE-220 Backup Power Systems, PAGE-300 Service & Maintenance and PAGE-310 Preventive Maintenance.
- PAGE-320 and PAGE-330 are complete editorial drafts but remain pending service-owner scope approval.
- Evolution Series Page, Power Planning & Integration, On-Site & Bridge Power, Facility Assessments, Emergency Service and eLERT remain **DO NOT PUBLISH** until their named governance decisions are resolved.
- No facilities-maintained number, response-time promise, monitored-facility count, product superlative, patent assertion, zero-downtime claim or unsupported equipment list appears.

---

# PAGE-200 — Power Generation

**URL:** `/power-generation/`  
**Page brief:** INTENT-200  
**Audience:** Owners, developers, power leaders, engineering teams, construction teams and operators  
**Primary action:** Discuss a Power Requirement  
...
- Do not name unapproved technologies, offers, operating modes or service areas in schema.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Lifecycle and power connection | CLM-003, 004, 014 | Pass |
| Aggregate power proof | CLM-007 | Pass—exact MW wording |
| Long-term support | CLM-013 | Pass |
| Evolution claims | CLM-028, 029 | Pass—excluded and clearly held |

**Content approval status:** Ready for stakeholder review; factual claims ledger pass complete.

---

# PAGE-220 — Backup Power Systems

**URL:** `/power-generation/backup-power-systems/`  
**Page brief:** INTENT-220  
**Audience:** Facility, power, engineering, commissioning and operations leaders  
**Primary action:** Discuss Backup Power  
...
- `Service`, `WebPage` and `BreadcrumbList`.
- No unapproved product, specification, runtime, redundancy or emissions properties.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Power/construction/lifecycle scope | CLM-003, 004, 013, 014 | Pass |
| Equipment and performance specifics | RQ-003 | Pass—excluded |

**Content approval status:** Ready for stakeholder review; factual claims ledger pass complete.

---

# PAGE-300 — Service & Maintenance

**URL:** `/maintenance/`  
**Page brief:** INTENT-300  
**Audience:** Data-center owners, operators, facilities leaders and reliability teams  
...
- `Service`, `WebPage` and `BreadcrumbList`.
- Do not include service-area breadth, response guarantees, facilities counts or unapproved asset lists.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Monitoring, maintenance and support | CLM-013, 014 | Pass |
| Lifecycle | CLM-003, 004 | Pass |
| Years in business | CLM-008 | Pass |
| Facilities count | CLM-015–017, 022 | Pass—excluded and disclosed as unresolved |
| Response claims | CLM-030, 031 | Pass—excluded |

**Content approval status:** Ready for stakeholder review; factual claims ledger pass complete.

---

# PAGE-310 — Preventive Maintenance

**URL:** `/maintenance/preventive-maintenance/`  
**Page brief:** INTENT-310  
**Audience:** Operations leaders, facility managers, reliability teams and asset owners  
**Primary action:** Request a Maintenance Discussion  
...
- `Service`, `WebPage` and `BreadcrumbList`.
- No unapproved asset coverage, intervals, staffing, availability or outcome claims.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| Maintenance and follow-on capability | CLM-013, 014 | Pass |
| Facilities count | CLM-015–017, 022 | Pass—excluded |
| Outage/response guarantees | CLM-029, 031 | Pass—explicitly not claimed |

**Content approval status:** Ready for stakeholder review; factual claims ledger pass complete.

---

# PAGE-320 — Power Generation Maintenance

**URL:** `/maintenance/power-generation-maintenance/`  
**Page brief:** INTENT-320  
**Status:** Editorially complete; **DO NOT PUBLISH until AD-006 confirms exact service scope**  

## Conditional draft

### Hero

# Maintain the power system in the context of the operating data center.

Power-generation maintenance should connect equipment condition, approved procedures, operating constraints, documentation and facility responsibilities.

### Page body

The power system does not operate independently from the data center it supports. Maintenance planning needs an accurate equipment basis, clear service boundaries, approved access and isolation requirements, and a process for escalating findings that fall outside routine work.

Evolve remains engaged after turnover through monitoring, maintenance and long-term support. Before this page publishes, the service owner must approve the exact equipment types, tasks, territory, availability, qualifications and response model included in Evolve's public scope.

### Proposed approach

1. Confirm asset records, documentation and operating requirements.
2. Define equipment and tasks within the service boundary.
3. Coordinate approved activity with facility operations.
4. Record work and findings in an agreed format.
5. Route repair, replacement, upgrade or power-conversion needs into a separately approved scope.

### Direct answers

#### What should a power-generation maintenance scope define?

It should define equipment, tasks, intervals, parts responsibilities, access, isolation, documentation, communications and escalation.

#### Does this page promise a response time or outage outcome?

No. Response and availability terms must be stated in the service agreement, and maintenance does not create a universal outage guarantee.

### CTA

**Proposed CTA:** Request Power Service

## Metadata recommendation

**Title:** Data Center Power Generation Maintenance | Evolve  
**Meta description:** Coordinate power-generation maintenance with data-center operations, documentation, service boundaries and follow-on facility decisions.  

## Schema recommendation

- Do not publish `Service` schema until AD-006 approves the visible service definition.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| General maintenance/support | CLM-013, 014 | Pass |
| Exact service scope | AD-006 / RQ-003 | **CONTENT HOLD** |

**Content approval status:** [CONTENT HOLD: AD-006 — exact power-generation maintenance scope requires Service & Maintenance owner approval]

---

# PAGE-330 — Critical Infrastructure Maintenance

**URL:** `/maintenance/critical-infrastructure-maintenance/`  
**Page brief:** INTENT-330  
**Status:** Editorially complete; **DO NOT PUBLISH until AD-006 approves asset scope**  

## Conditional draft

### Hero

# Define the systems, interfaces and responsibilities that the facility depends on.

Critical-infrastructure maintenance should begin with an approved asset boundary and a clear understanding of operating constraints.

### Page body

The term “critical infrastructure” is too broad to serve as a maintenance scope by itself. Owners need to identify which systems are included, what work is planned, how access and isolation are controlled, what documentation is required and how findings move into repair or capital work.

Evolve's approved capability includes monitoring, maintenance, upgrades, expansions, retrofits and power conversions. Before this page publishes, Evolve must approve the specific asset classes and services it will represent publicly.

### Proposed approach

1. Establish the facility and asset basis.
2. Define the criticality and service boundary.
3. Coordinate work with operating requirements.
4. Document findings and responsible actions.
5. Separate routine maintenance from repair, upgrade or retrofit scope.

### CTA

**Proposed CTA:** Request Service

## Metadata recommendation

**Title:** Critical Data Center Infrastructure Maintenance | Evolve  
**Meta description:** Define critical-infrastructure maintenance around approved assets, operating constraints, responsibilities and documented follow-on actions.  

## Schema recommendation

- Do not publish `Service` schema until the visible asset scope is approved.

## Claim review

| Module | Claim IDs | Review |
|---|---|---|
| General maintenance/retrofit scope | CLM-013, 014 | Pass |
| Specific asset classes | AD-006 | **CONTENT HOLD** |

**Content approval status:** [CONTENT HOLD: AD-006 — exact asset and service scope requires Service & Maintenance owner approval]

---

# Gated ancillary pages — no publishable copy authorized

| Page ID | Page | URL | Reason | Required decision |
|---|---|---|---|---|
| PAGE-210 | Evolution Series | `/power-generation/evolution-series/` | Public product definition, specifications, patent language and benefits are not approved | AD-002; resolve CLM-028/029 and approve a current product claim pack |
| PAGE-230 | Power Planning & Integration | `/power-generation/power-planning-integration/` | Exact contracted service scope is not approved | RQ-002/RQ-003; product/service owner approval |
| PAGE-240 | On-Site & Bridge Power | `/power-generation/onsite-bridge-power/` | Approved use cases, technologies and responsibilities are not defined | RQ-003; product/legal approval |
| PAGE-340 | Facility Assessments & Support | `/maintenance/facility-assessments/` | Assessment deliverable and scope are not defined | Architecture gating requirement; service owner approval |
| PAGE-350 | Emergency Service | `/maintenance/emergency-service/` | Territory, availability and response model are not approved | AD-006; resolve CLM-030/031 |
| PAGE-400 | eLERT | `/elert/` | Canonical product definition, platform scope, coverage and claims are not approved | AD-003; resolve CLM-018/032 |
| PAGE-820 | Request an eLERT Assessment | `/elert/request-assessment/` | Assessment deliverable and fulfillment owner are not defined | AD-003 |

## Safe navigation/placeholder rule

Do not expose these pages in public navigation, XML sitemaps, metadata or schema. Internal staging may use the page title plus the corresponding content-hold record, but no benefit, specification, monitoring, availability, patent or performance statement should be visible publicly.
...
|---|---|---|---|---|---|
| REV-COPY-001B-1 | PAGE-200, 220, 300, 310 | Pass against GOV-001 v1.0 | Pass | Pass | Ready for Evolve stakeholder review |
| REV-COPY-001B-2 | PAGE-320, 330 | Approved general claims only; scope holds remain | Pass conditionally | Pass | **DO NOT PUBLISH pending AD-006** |
| REV-COPY-001B-3 | PAGE-210, 230, 240, 340, 350, 400, 820 | No unauthorized copy drafted | N/A | Pass | **DO NOT PUBLISH** |

## Change-log entry

| Change ID | Timestamp | Artifact/version | Old state | New state | Reason | Upstream IDs | Affected pages |
|---|---|---|---|---|---|---|---|
| COPY-CHG-001B | 2026-09-07 | COPY-001B v1.0 | Draft/unsupported service and product copy | Governed Power/Maintain copy plus explicit page gates | Promote ancillary services without inventing product, coverage or maintenance facts | GOV-001, MKT-001, ARCH-001, DS-001 | PAGE-200–240, 300–350, 400, 820 |
