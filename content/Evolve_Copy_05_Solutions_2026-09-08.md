...
- No customer names, logos, locations, capacities, schedules, savings or performance outcomes.
- No facilities-maintained number, response-time promise, monitored-facility count, product superlative or patent language.
- No Evolve-specific rack-density, cooling, edge product or platform claims.
- Detailed service intent stays with the Design & Build, Power Generation and Service & Maintenance pages; each solution page links to them.
...
**URL:** `/solutions/`  
**Page brief:** INTENT-900  
**Audience:** Owners, developers and operators who start from the kind of facility or project they need, not from a service category  
...
## Tell Evolve which kind of facility you are delivering.

Share the facility type, the project stage and the constraint that matters most right now.
...
|---|---|---|
| Lifecycle framing | CLM-003, 004 | Pass |
...
# PAGE-910 — AI / HPC Data Centers

**URL:** `/solutions/ai-hpc-data-centers/`  
**Page brief:** INTENT-910  
**Audience:** AI infrastructure developers, high-performance-computing operators, engineering and power leaders  
...
[AI Data Centers in Design & Build](/design-build/ai-data-centers/)  
...
| Module | Claim IDs | Review |
|---|---|---|
| AI category and lifecycle | CLM-001, 003, 004, 005 | Pass |
| Modular fabrication | CLM-011 | Pass |
...
# PAGE-920 — Edge Data Centers

**URL:** `/solutions/edge-data-centers/`  
**Page brief:** INTENT-920  
**Audience:** Operators deploying smaller, distributed or remote capacity  
**Primary action:** Discuss Distributed Infrastructure  
...
| Module | Claim IDs | Review |
|---|---|---|
| Modular fabrication and site-set wording | CLM-011, 012 | Pass—qualified |
...
# PAGE-930 — Modular Data Centers

**URL:** `/solutions/modular-data-centers/`  
**Page brief:** INTENT-930  
**Audience:** Owners evaluating factory-built delivery for any facility type  
...
[Modular Data Centers in Design & Build](/design-build/modular-data-centers/)  
...
| Module | Claim IDs | Review |
|---|---|---|
| Fabrication and site-set wording | CLM-011, 012 | Pass—qualified |
...
# PAGE-940 — Colocation Data Centers

**URL:** `/solutions/colocation-data-centers/`  
**Page brief:** INTENT-940  
**Audience:** Colocation owners, developers and operators  
...
[Colocation in Data Center Markets](/data-center-markets/colocation/)  
...
| Module | Claim IDs | Review |
|---|---|---|
| Construction and live-environment scope | CLM-013, 014 | Pass |
...
# PAGE-950 — Greenfield New Builds

**URL:** `/solutions/greenfield-new-builds/`  
**Page brief:** INTENT-950  
**Audience:** Developers and owners starting a data center on a new site  
...
# PAGE-960 — Brownfield & Retrofit

**URL:** `/solutions/brownfield-retrofit/`  
**Page brief:** INTENT-960  
**Audience:** Owners and operators of existing facilities  
...
**Title:** Brownfield and Retrofit Data Center Solutions | Evolve  
**Meta description:** Retrofit, upgrade, expand or convert an existing facility with live-environment construction planned around the systems that must stay running.  
...
| Module | Claim IDs | Review |
|---|---|---|
| Retrofit and live-environment scope | CLM-014 | Pass |
